...
namespace CairoDesktop
{
    ...
    public class ApplicationWindow : IEquatable<ApplicationWindow>, ICairoNotifyPropertyChanged
    {
        ...
        private WindowShowStyle _currentState = WindowShowStyle.Minimize;
        ...
        public ApplicationWindow(IntPtr handle, WindowsTasksService sourceService)
        {
            ...
            State = _lastWindowPlacement.showCmd == (int)WindowShowStyle.ShowMinimized ? WindowState.Inactive : WindowState.Active;
            _currentState = (WindowShowStyle)_lastWindowPlacement.showCmd;
            _showName = CairoDesktop.Properties.Settings.Default.ShowAppNameOnTaskbar;
        ...
        public string Title
        {
            get
            {
                ...
                if (this.Handle == IntPtr.Zero)
                    return "Desktop";//Desktop icon, depricated now
        ...
        public WindowState State
        {
            get
            {
                ...
                placement.length = Marshal.SizeOf(_lastWindowPlacement);
                ...
                if (placement.showCmd == (int)WindowShowStyle.ShowNormal || placement.showCmd == (int)WindowShowStyle.ShowMaximized)
                {
        ...
        public void BringToFront()
        {
            if (Handle != IntPtr.Zero)
            {
                ...
                placement.length = Marshal.SizeOf (_lastWindowPlacement);
                GetWindowPlacement (this.Handle, out placement);
                _currentState = (WindowShowStyle)placement.showCmd;
                ...
                //Fix the state
                State = CairoDesktop.ApplicationWindow.WindowState.Active;
            }
        ...
        public void Minimize()
        {
            ...
            _lastWindowPlacement.length = Marshal.SizeOf(_lastWindowPlacement);
            GetWindowPlacement(this.Handle, out _lastWindowPlacement);
            if (this.Handle == IntPtr.Zero || _currentState == WindowShowStyle.ShowMinimized)//If it has no handle or is already minimized.. leave it alone
            ...
            //Fix the state
            State = CairoDesktop.ApplicationWindow.WindowState.Inactive;
        }
        ...
        public void Maximize()
        {
            ...
            _currentState = (WindowShowStyle)_lastWindowPlacement.showCmd;
            //...In your code some where: show a form, without making it active
            ShowWindow(this.Handle, WindowShowStyle.ShowNormal);
            //Fix the state
            State = CairoDesktop.ApplicationWindow.WindowState.Active;
        }
